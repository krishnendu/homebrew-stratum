...
class Stratum < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/krishnendu/stratum/releases/download/v0.2.5/stratum-v0.2.5-aarch64-apple-darwin.tar.gz"
      sha256 "606f4889f85c0ddf86725f51f7227887a66cb813748c733095d2860af7fed49d"
    end
  end
