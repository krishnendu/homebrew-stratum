...
class Stratum < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/krishnendu/stratum/releases/download/v0.2.7/stratum-v0.2.7-aarch64-apple-darwin.tar.gz"
      sha256 "a75b27b6323c51f985590e5c9a267232417c08ce44b82db2a044383f000b2109"
    end
  end

  on_linux do
    on_intel do
      # Linux build not yet shipped in v0.2.2 manual release; users on
      # Linux should use the source build via stratum-llama-cpp formula
      # or wait for the next CI-built tagged release.
