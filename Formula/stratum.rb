...
class Stratum < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/krishnendu/stratum/releases/download/v0.2.6/stratum-v0.2.6-aarch64-apple-darwin.tar.gz"
      sha256 "1eadaae312ba0cbc285209e63a7d9a00612fc69a0c0fcbe614dd0c329d6f2c7d"
    end
  end
