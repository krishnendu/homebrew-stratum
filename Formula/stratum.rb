...
class Stratum < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/krishnendu/stratum/releases/download/v0.2.4/stratum-v0.2.4-aarch64-apple-darwin.tar.gz"
      sha256 "5858048d7616ef9dd4223ee6b03f763f37ccb40bcc6579f8b66858f25b2c1a68"
    end
  end
